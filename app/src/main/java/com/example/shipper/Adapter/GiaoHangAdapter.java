...
public class GiaoHangAdapter extends RecyclerView.Adapter<GiaoHangAdapter.DatHangViewHolder> {

    Context context;
    ArrayList<ChiTietDonHang> lst;

    public GiaoHangAdapter(Context context, ArrayList<ChiTietDonHang> lst) {
